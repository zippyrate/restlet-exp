...
import exp.restlet.resources.EPadWebServiceResource;
 ...
 * @author martin
 */
public class EPadWebServiceServerResource extends ServerResource implements EPadWebServiceResource
{
	private final Logger logger = LoggerFactory.getLogger(EPadWebServiceServerResource.class);
