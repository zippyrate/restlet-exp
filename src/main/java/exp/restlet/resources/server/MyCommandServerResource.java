...
import exp.restlet.resources.MyCommandResource;
 ...
 * @author martin
 */
public class MyCommandServerResource extends ServerResource implements MyCommandResource
{
	private final Logger logger = LoggerFactory.getLogger(MyCommandServerResource.class);
	...
	public MyCommandServerResource()
	{
	...
	{
		logger.warn("An exception was thrown in the window level resource.\n");
	}
